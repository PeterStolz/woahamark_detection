"""Evaluate dalle_detector. Threshold tuned on val (only 2 positives — expect a clear margin)."""
...
from .detect import default_config_and_template, score


def score_split(items, score_fn):
    scores, labels, paths = [], [], []
